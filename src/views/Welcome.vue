...
<template>
  <div>
          ...
          <div class="col-lg-5">
            ...
            <div class="hero-content-text">
              ...
              <h2 class="wow fadeInUp" data-wow-delay="900ms"
                  style="visibility: visible; animation-delay: 900ms; animation-name: fadeInUp;">少儿编程俱乐部
              </h2>
            ...
            <div class="single-care-card relative text-center wow fadeInLeft" data-wow-delay="700ms"
              ...
              <div class="care-card-img-content">
                ...
                <div class="care-content-text">
                  <h4>Java全套实战路线</h4>
                  <p>从JavaSE入门开始学习，接着是JavaWeb网页后端开发，JSP大学课设折磨，
                    SSM框架学习，SpringBoot一步到位，SpringCloud一飞冲天</p>
                  <div class="care-count-info">
                    <p class="mb-0"><span>课时:</span> 6个月 </p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="single-care-card relative text-center wow fadeInLeft" data-wow-delay="900ms"
              ...
              <div class="care-card-img-content">
                ...
                <div class="care-content-text">
                  <h4>Scratch模块编程</h4>
                  <p>适用于中国宝宝体质的少儿编程软件，像拼图一样进行程序开发和设计，与网页上出现的动画实时交互</p>

                  <div class="care-count-info">
                    <p class="mb-0"><span>课时:</span> 3个月 </p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="single-care-card relative text-center wow fadeInLeft" data-wow-delay="1100ms"
              ...
              <div class="care-card-img-content">
                ...
                <div class="care-content-text">
                  ...
                  <div class="care-count-info">
                    <p class="mb-0"><span>课时:</span> 8个月 </p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="gra-cert-image-area relative">
              ...
              <div class="play-btn">
                <div class="video_player_btn">
                  <a href="https://www.youtube.com/watch?v=eEzD-Y97ges" class="popup-video"><span
    ...
    <div class="partner-area-2 wow fadeInUp" data-wow-delay="700ms"
         style="visibility: visible; animation-delay: 700ms; animation-name: fadeInUp;">
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="single-counter-2-card d-flex align-items-center wow fadeInDown" data-wow-delay="500ms"
                 style="visibility: visible; animation-delay: 500ms; animation-name: fadeInDown;">
              <!-- icon -->
          ...
          <!-- Single card -->
          <div class="col-sm-6 col-lg-4">
            <div class="single-counter-2-card d-flex align-items-center wow fadeInDown" data-wow-delay="700ms"
                 style="visibility: visible; animation-delay: 700ms; animation-name: fadeInDown;">
              <!-- icon -->
              <div class="counter-2-icon">
          ...
          <!-- Single card -->
          <div class="col-sm-6 col-lg-4">
            <div class="single-counter-2-card d-flex align-items-center wow fadeInDown" data-wow-delay="900ms"
                 style="visibility: visible; animation-delay: 900ms; animation-name: fadeInDown;">
              <!-- icon -->
              <div class="counter-2-icon">
                <span class="icon-ruler-combined-solid-1"></span>
    ...
    <div class="portfolio-area">
      ...
      <div class="container">
        ...
        <div class="row g-4 g-lg-5 gallery-area" style="position: relative; height: 418.5px;">
          <!-- Card -->
    ...
    <div class="client-area-home-2 relative">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div
                class="swiper client-active-2 wow fadeInRight swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden"
                data-wow-delay="900ms"
                style="visibility: visible; animation-delay: 900ms; animation-name: fadeInRight;">
              <!-- If we need navigation buttons -->
              <div class="testimonials-3-navigation-wrapper position-relative">
                <div class="common-slider-navigation">
                  <button class="client-active-1-button-prev" tabindex="0" aria-label="Previous slide"
                          aria-controls="swiper-wrapper-5c5510fe4897790fb"><span class="icon-arrow-right"></span>
                  </button>
                  <button class="client-active-1-button-next" tabindex="0" aria-label="Next slide"
                          aria-controls="swiper-wrapper-5c5510fe4897790fb"><span class="icon-right"></span></button>
                </div>
              </div>
              <div class="swiper-wrapper" id="swiper-wrapper-5c5510fe4897790fb" aria-live="off"
                   style="transition-duration: 0ms; transform: translate3d(-1158px, 0px, 0px);">
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev"
                     ...
                     style="width: 509px; margin-right: 70px;">
